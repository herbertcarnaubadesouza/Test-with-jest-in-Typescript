...
describe("Create an User", function () {
    ...
    it("should be to create an user", function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it("should not be able to create an user that already exists", function () {
