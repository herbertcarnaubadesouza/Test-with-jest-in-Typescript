...
describe("Authenticate User Controller", function () {
    ...
    it("should be able to athenticate user", function () { return __awaiter(void 0, void 0, void 0, function () {
        var responseToken;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it("should not be able to authenticate user, if the user not exists", function () { return __awaiter(void 0, void 0, void 0, function () {
        var responseToken;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, supertest_1.default(app_1.app).post("/sessions")
