...
var GetBalanceUseCase_1 = require("../getBalance/GetBalanceUseCase");
...
describe("Create Statment", function () {
    beforeEach(function () {
        ...
        getBalanceUseCase = new GetBalanceUseCase_1.GetBalanceUseCase(statementsRepository, usersRepositoryInMemory);
    });
    it("should be able to create a statment", function () { return __awaiter(void 0, void 0, void 0, function () {
        var user, returnedUser, statement, returnedStatement;
    ...
    it("should not be able to create a statment, if the user does not exist", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            }); }).rejects.toBeInstanceOf(CreateStatementError_1.CreateStatementError.UserNotFound);
            return [2 /*return*/];
        });
    }); });
});
